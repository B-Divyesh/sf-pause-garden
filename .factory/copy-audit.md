...
| A garden opens on turn seven. | 6 | Pass |
| No setup is needed. | 4 | Pass |
...
| Mark a player sleeping | 4 | Pass |
| Their queued token remains available. | 5 | Pass |
...
| One complete chapter | 3 | Pass |
| Creates a garden from a visible seed. | 7 | Pass |
| Saves the current turn after every action. | 7 | Pass |
| Restores the room after a refresh. | 6 | Pass |
| No pressure to stay online | 5 | Pass |
| No timers, combat, or daily streaks. | 6 | Pass |
| No account, chat, or public player list. | 7 | Pass |
| This static v1 uses one shared screen. | 7 | Pass |
...
| No player data is sent from the game. | 8 | Pass |
...
| Concept | Word used |
| --- | --- |
| One play session | chapter |
| Shared saved game | room |
| Player temporarily absent | sleeping |
